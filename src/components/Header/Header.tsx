...
const Header = () => {
    ...
    return (
        <div className='bg-gradient-to-bl from-[#f53d2d] to-[#f63] px-16 py-2 text-white'>
            {/* Top header */}
            ...
            <div className='flex items-end gap-x-8 py-4'>
                {/* Logo */}
                <Link to={path.HOME}>
                    <svg viewBox='0 0 192 65' className='fill-white w-[160px]'>
                        <g fillRule='evenodd'>
                ...
                <form className='flex flex-1 gap-x-2 bg-white p-1 rounded w-full h-[44px]'>
                    ...
                    />
                    <button className='flex justify-center items-center bg-primary rounded w-14 h-full'>
