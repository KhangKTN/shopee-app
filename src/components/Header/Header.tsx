    ...
    return (
        <div className='py-2 px-16 bg-primary text-white'>
                ...
                <div className='flex gap-x-3 items-center'>
                    ...
                    {isAuthenticated ? (
                        ...
                        <div className='flex items-center gap-x-3 font-semibold'>
                            ...
                            <div className='border-r-[1px] h-3 border-white/40'></div>
            ...
            <div className='flex gap-x-8 items-end py-4'>
                <svg viewBox='0 0 192 65' className='w-[160px] fill-white'>
                    <g fillRule='evenodd'>
                ...
                <form className='h-[44px] w-full flex-1 flex gap-x-2 p-1 bg-white rounded'>
                    <input
                        className='h-full w-full text-black focus:outline-gray-600 focus:outline-2 ps-3'
                        type='text'
                        placeholder='Siêu sale'
                    />
                    <button className='bg-primary h-full w-14 rounded flex items-center justify-center'>
